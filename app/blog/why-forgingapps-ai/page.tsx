      ...
      <div className="container-custom max-w-3xl">
        ...
        <div className="prose prose-invert max-w-none mb-12">
          <div className="space-y-6 text-gray-300 leading-relaxed">
            ...
            <p>
              We are based in Sofia, Bulgaria and serve businesses across Europe. We also know how to ship serious software under serious standards — the team behind ForgingApps won the umlaut Secure App Award, and that engineering discipline carries into the AI work too.
            </p>
            ...
            <p>
              We&apos;ve built AI support systems for e-commerce that can handle 70% or more of routine customer questions, invoice-processing pipelines that remove manual admin, AI-assisted content workflows, and custom agents for business operations. The details vary, but the pattern stays the same: remove friction, improve responsiveness, and keep the solution grounded in how the business actually works.
            </p>
