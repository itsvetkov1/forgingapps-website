...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const corePages = [
    ...
    { url: `${base}/en/workshop`, lastModified: lastmod, priority: 0.9, changeFrequency: 'daily' as const },
    { url: `${base}/bg/workshop`, lastModified: lastmod, priority: 0.9, changeFrequency: 'daily' as const },
    { url: `${base}/en/workshop/facebook-autopilot`, lastModified: lastmod, priority: 0.7, changeFrequency: 'weekly' as const },
    { url: `${base}/bg/workshop/facebook-autopilot`, lastModified: lastmod, priority: 0.7, changeFrequency: 'weekly' as const },
    { url: `${base}/en/workshop/disclosure`, lastModified: lastmod, priority: 0.5, changeFrequency: 'monthly' as const },
    { url: `${base}/bg/workshop/disclosure`, lastModified: lastmod, priority: 0.5, changeFrequency: 'monthly' as const },
    ...
    { url: `${base}/en/legal/privacy`, lastModified: lastmod, priority: 0.3, changeFrequency: 'yearly' as const },
    { url: `${base}/bg/legal/privacy`, lastModified: lastmod, priority: 0.3, changeFrequency: 'yearly' as const },
    { url: `${base}/en/legal/data-deletion`, lastModified: lastmod, priority: 0.3, changeFrequency: 'yearly' as const },
    { url: `${base}/bg/legal/data-deletion`, lastModified: lastmod, priority: 0.3, changeFrequency: 'yearly' as const },
