...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const corePages = [
    ...
    { url: `${base}/services`, lastModified: lastmod, priority: 0.9, changeFrequency: 'monthly' as const },
    { url: `${base}/ai-consulting`, lastModified: lastmod, priority: 0.9, changeFrequency: 'monthly' as const },
    { url: `${base}/about`, lastModified: lastmod, priority: 0.7, changeFrequency: 'monthly' as const },
    { url: `${base}/contact`, lastModified: lastmod, priority: 0.8, changeFrequency: 'monthly' as const },
    { url: `${base}/privacy`, lastModified: lastmod, priority: 0.3, changeFrequency: 'yearly' as const },
    { url: `${base}/terms`, lastModified: lastmod, priority: 0.3, changeFrequency: 'yearly' as const },
