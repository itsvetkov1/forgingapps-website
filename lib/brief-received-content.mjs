const STARTER_PROMPTS = {
  ...
  bg: [
    ...
    'Мога ли да видя още от работата ви?',
  ],
}

const TIMELINE = {
  en: [
    { title: 'Founder reads your brief', meta: 'Within a week', detail: 'Active review window', state: 'active' },
  ...
  bg: [
    { title: 'Основателят преглежда запитването Ви', meta: 'До една седмица', detail: 'Първият преглед вече е в ход', state: 'active' },
